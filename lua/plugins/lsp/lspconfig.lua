  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(event)
        ...
        -- NOTE: LSP navigation (gd, gr, gI, gy) handled by snacks.picker in snacks.lua
        -- Keeping grD here as snacks doesn't have a declaration picker
        ...
        -- Hover error
        map('<leader>e', vim.diagnostic.open_float, 'Hover [e]rror')
